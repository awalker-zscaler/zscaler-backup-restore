...
$response = Invoke-WebRequest -Uri "https://raw.githubusercontent.com/$($global:zscaler.settings.Github.owner)/$($global:zscaler.settings.Github.Repo)/main/functions/zpa/Authentication.ps1"
...
IF($global:zscaler.ZPAEnvironment.authenticated){
    ...
    Invoke-Expression((Invoke-WebRequest -Uri "https://raw.githubusercontent.com/$($global:zscaler.settings.Github.owner)/$($global:zscaler.settings.Github.Repo)/main/functions/zpa/invoke-zpa-swagger.ps1").content)
